...
// Tipe data untuk FeedPost (gunakan JSDoc untuk anotasi tipe di file JS)
/**
 ...
 * @property {string|null} author_profile_picture_url
 * @property {number} like_count
 * @property {number} comment_count
 * @property {boolean} is_liked_by_me
 */
...
export default function HomePage() {
  ...
  const fetchFeedPosts = useCallback(async (pageNum, isInitialLoad = false) => {
    if (isInitialLoad) {
      setIsLoading(true);
    } else {
